...
model = AutoModelForCausalLM.from_pretrained(model_id, torch_dtype=torch.float16).to("mlu")  # 将模型加载到 MLU370.SHARE 设备上
...
output = model.generate(input_ids, max_length=240, do_sample=True, top_p=0.95, temperature=1.0)
